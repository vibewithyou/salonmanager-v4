...
import { EyeIcon, EyeSlashIcon, ScissorsIcon } from '@heroicons/react/24/outline';
      ...
      <div className="max-w-md w-full">
        <div className="card p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h3 className="text-2xl font-bold text-yellow-500 mb-2">Willkommen zurück</h3>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 pr-12 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  ...
                  onChange={handleChange}
                  className="mr-2 text-yellow-500 bg-transparent border-gray-600 rounded focus:ring-yellow-500"
                />
                <span className="text-sm text-gray-300">Angemeldet bleiben</span>
              </label>
              <Link
                to="/forgot-password"
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-900 text-gray-400">Oder</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <button
              type="button"
              className="w-full flex items-center justify-center px-4 py-3 border border-gray-600 rounded-lg text-white hover:bg-gray-800 transition-colors duration-200"
            >
